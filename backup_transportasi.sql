...
INSERT INTO `dokumen_peminjaman` VALUES (1,1,'doc_697c2f77b4764.jpg'),(2,2,'doc_697c33afa3895.jpg'),(3,3,'doc_697d8dc174e1c.jpg');
...
CREATE TABLE `peminjaman` (
  ...
  `kategori_kendaraan` enum('kampus','yayasan','luar') NOT NULL,
  ...
  `dokumen` text,
  `status` enum('menunggu','disetujui','ditolak','dibatalkan_user') NOT NULL,
  `catatan_admin` text,
...
INSERT INTO `peminjaman` VALUES (1,2,'kampus','APV',2,'2026-01-01','2026-01-01','sragen','tugas',NULL,'disetujui',NULL,'2026-01-30 04:11:35',NULL,NULL),(2,3,'luar','ELF LONG',10,'2026-02-01','2026-02-03','surabay','tugas',NULL,'ditolak',NULL,'2026-01-30 04:29:35',NULL,NULL),(3,2,'yayasan','LUXIO',2,'2026-02-20','2026-02-22','ponorogo','tugas',NULL,'disetujui',NULL,'2026-01-31 05:06:09',NULL,NULL),(4,3,'kampus','APV',4,'2026-01-01','2026-01-01','jogja','pulang','dok_3_1769842944_0.jpg','dibatalkan_user',NULL,'2026-01-31 07:02:24',NULL,'2026-01-31 14:12:04'),(5,2,'kampus','ELF',2,'2010-03-22','2002-09-20','ponorogo','ketemu pacar','dok_2_1769855236_0.jpg','ditolak',NULL,'2026-01-31 10:27:16',NULL,NULL),(6,2,'kampus','APV Luxury',2,'2026-01-01','2026-01-01','ponorogo','tugas','dok_2_1769916572_0.pdf','ditolak',NULL,'2026-02-01 03:29:32',NULL,NULL);
...
INSERT INTO `users` VALUES (1,'adminunida','adminunida','adminunida@unida.ac.id',NULL,'21232f297a57a5a743894a0e4a801fc3','admin',NULL),(2,'aisyah','aisyah','aisyah@unida.ac.id',NULL,'26bb533df5747c7a3f2a9cc48a8cf3ee','user','user_2_1769837712.jpg'),(3,'amira','amira','amira@unida.ac.id',NULL,'0ae39049910b110bea964228da2c9faa','user','user_3_1769843632.jpg'),(4,NULL,'aisyahdzakirah41','aisyahdzakirah41@student.cs.unida.gontor.ac.id',NULL,'482c811da5d5b4bc6d497ffa98491e38','user',NULL),(5,NULL,'assyifa','assyifa@student.cs.unida.gontor.ac.id',NULL,'assyifa','user',NULL);
...
-- Dump completed on 2026-02-01 19:27:57
